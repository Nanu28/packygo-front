  ...
  return (
    <section className="flex flex-col bg-[url('../public/image/backgroundLetsGo.png')] bg-cover bg-center md:flex-row">
      <div className='w-48 flex self-center md:w-1/3'>
        <img src="../public/image/girlTravel.png" alt="image_girlTravel" />
      </div>
      <div className='w-full py-4 flex flex-col justify-center md:w-1/2'>
        ...
        <div className='flex justify-center'>
          <Link to="/store">
            <button className='bg-navbar-bg hover:bg-sky-900 text-white font-bold h-10 w-48 rounded-2xl mt-2 md:ml-20'>
              Shop now
            </button>
          </Link>
        </div>
