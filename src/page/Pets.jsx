        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6'>
                ...
                <div class="bg-red-200 shadow-md h-4/5 ">
                    <img className='h-56 object-cover w-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxQnYyPezAZVbF1RQius3LfoR1uXvJt1SQKIYWrVPXXX3QJj32R-r65TvdipdMpTfbSAo&usqp=CAU" class="w-full h-40 object-cover " />
                ...
                <div className="bg-red-200 shado h-4/5 w-md">
                    <img classNameName='h-56 object-cover w-full' src="https://www.eltiempo.com/files/image_950_534/uploads/2017/02/12/58a06c78ae556.jpeg" className="w-full h-40 object-cover " />
