        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6'>
                ...
                <div class="shadow-md h-4/5 ">
                    <img className='h-40 object-cover w-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxQnYyPezAZVbF1RQius3LfoR1uXvJt1SQKIYWrVPXXX3QJj32R-r65TvdipdMpTfbSAo&usqp=CAU" class="w-full h-40 object-cover " />
                    <div class="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                        <h5 class="text-xl font-bold">Malta</h5>
                        <p className="text-gray-600 min-h-4/5">Airlines require visually impaired passengers to notify at least two days before the flight. It is important to contact the airline and airport to request assistance. Airport staff assist with check-in, security checks and boarding gate. The crew offers accessible safety information. Guide dogs are allowed at no additional cost if advance notice is given.
                        </p>
                ...
                <div className="shadow-md h-4/5 w-md">
                    <img classNameName='h-40 object-cover w-full' src="https://www.eltiempo.com/files/image_950_534/uploads/2017/02/12/58a06c78ae556.jpeg" className="w-full h-40 object-cover " />
                    <div className="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                        <h5 className="text-xl font-bold">  Si viaja en avión</h5>
                        <p className="text-gray-600 min-h-4/5">
                            ...
                            – Asegúrese de que el personal de la aerolínea trate a su mascota con la responsabilidad y el cuidado que merece.</p>
