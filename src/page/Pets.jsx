                ...
                <div className=" h-full p-2 w-96 gap-10 ">
                    ...
                    <div class="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                        ...
                        <p className="text-gray-600 h-96">
                            ...
                            – Si su mascota ha tenido dificultades de salud recientes, quizá viajar no sea una buena idea.

                            – Mascotas de raza braquicéfala no deben ser sometidas a viajes de más de cuatro horas.
                ...
                <div className=" h-full p-2 w-96 gap-10 ">
                    ...
                    <div className="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                        ...
                        <p className="text-gray-600 h-96">
                            ...
                            – Consulte la reglamentación de cada aerolínea en cuanto al transporte de animales de compañía.
                            ...
                            – Tenga a mano todos los documentos que certifiquen que su mascota puede viajar en la cabina del avión: certificado de soporte emocional, certificado de vacunas, etc.
