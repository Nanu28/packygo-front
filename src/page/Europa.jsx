            ...
            <div>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6'>
                    ...
                    <div class="shadow-md h-4/5 ">
                        <img className='h-40 object-cover w-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ02ReqzrsWTCMZbkppGNdmwnXN5yURQdWBFg&usqp=CAU" class="w-full h-40 object-cover " />
                    ...
                    <div class="shadow-md h-4/5 ">
                        ...
                        <img className='h-40 object-cover w-full' src="https://www.wradio.com.co/resizer/0tNr79x1rNv3_CxHxjjFQdfer7Q=/650x488/filters:format(jpg):quality(70)/cloudfront-us-east-1.images.arcpublishing.com/prisaradioco/C2W34A24OJHANF3BT5V3IM3RWU.jpg" />
                        <div class="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                    ...
                    <div className="bg-red-200 shado h-4/5 w-md">
                        <img classNameName='h-40 object-cover w-full' src=" https://f.fcdn.app/imgs/46b007/mispetates.com/mipeuy/18d2/original/catalogo/OHR.LH354-17-5/460x460/set-organizador-de-valija-con-6-sobres-azul.jpg" className="w-full h-40 object-cover " />
                    ...
                    <div className="shadow h-4/5 w-md">
                        <img classNameName='h-40 object-cover w-full' src="https://h7w7b8g4.stackpathcdn.com/wp-content/uploads/2018/09/Acessorios-de-viagem.jpg" className="w-full h-40 object-cover " />
                        <div className="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                            <h5 className="text-xl font-bold">Cama compartida</h5>
                            <p className="text-gray-600 min-h-4/5">
                    ...
                    <div className="shadow h-4/5 w-md">
                        <img classNameName='h-40 object-cover w-full' src="https://h7w7b8g4.stackpathcdn.com/wp-content/uploads/2018/09/Pochete-Doleira-Dinheiro-Viagem-Acessorio.jpg" className="w-full h-40 object-cover " />
                        <div className="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                            <h5 className="text-xl font-bold">Cama compartida</h5>
                            <p className="text-gray-600 min-h-4/5">
                    ...
                    <div className="shadow-md h-4/5 w-md">
                        <img classNameName='h-40 object-cover w-full' src="https://h7w7b8g4.stackpathcdn.com/wp-content/uploads/2018/09/carregador-portatil-celular-camera-acessorio-viagem.jpg" className="w-full h-40 object-cover " />
                        <div className="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                            <h5 className="text-xl font-bold">Cama compartida</h5>
                            <p className="text-gray-600 min-h-4/5">
