        ...
        <div className='bg-sky-50'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-6'>
                ...
                <div class="shadow-md h-4/5 ">
                    <img className='h-40 object-cover w-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQof626K2P5_Gq6i7HG3ic0NgFnlfrbdVgOFA&usqp=CAU" class="w-full h-40 object-cover " />
                ...
                <div class="shadow-md h-4/5 ">
                    ...
                    <img className='h-40 object-cover w-full' src="https://eaqxr36k8gu.exactdn.com/wp-content/uploads/2013/07/que-ver-y-hacer-en-paris-torre-eiffel.jpg?strip=all&lossy=1&resize=1000%2C621&ssl=1" />
                    <div class="bg-gray-100 min-h-[35%] p-4 flex flex-col justify-between">
                ...
                <div className="shado h-4/5 w-md">
                    <img classNameName='h-40 object-cover w-full' src="https://www.guiaenturismo.com/wp-content/uploads/2018/01/Las-Tendencias-Turisticas-Populares-en-Europa.jpg" className="w-full h-40 object-cover " />
